...
namespace EllipticCurve
{
    ...
    public class Curves
    {
        ...
        public static CurveFp getCurveByType(CurveType type) => type switch
        {
            CurveType.sec160r1 => Curves.sec160r1,
            CurveType.sec160k1 => Curves.sec160k1,
            CurveType.sec256k1 => Curves.secp256k1,
            _ => throw new ArgumentException("unknow curve")
